...
public class UserAgentUtil {
   ...
   private static UserAgent judgeBrowser(String userAgent, String platformType, String platformSeries, String platformVersion) {  
       if (userAgent.contains("Chrome")) {  
            ...
            * IE 系列 
            * ******* 
            * MSIE 11.0    -   Internet Explorer 11 || Trident/7.0
            ...
            * 判断依据:http://msdn.microsoft.com/en-us/library/ms537503(v=vs.85).aspx 
            */  
           if (userAgent.contains("MSIE 11.0") || (userAgent.contains("Trident/7.0") && userAgent.contains("rv:11.0"))) {//Internet Explorer 11  
   ...
   public static boolean isIE(HttpServletRequest request) {
	   UserAgent ua = getUserAgent(request.getHeader("User-Agent"));
	   if (ua != null && "Internet Explorer".equalsIgnoreCase(ua.getBrowserType())) {
		   return true;
	   }
	   return false;
   }
   ...
   public static boolean isChrome(HttpServletRequest request) {
	   UserAgent ua = getUserAgent(request.getHeader("User-Agent"));
	   if (ua != null && "Chrome".equalsIgnoreCase(ua.getBrowserType())) {
		   return true;
	   }
	   return false;
   }
   ...
   public static boolean isFirefox(HttpServletRequest request) {
	   UserAgent ua = getUserAgent(request.getHeader("User-Agent"));
	   if (ua != null && "Firefox".equalsIgnoreCase(ua.getBrowserType())) {
		   return true;
	   }
	   return false;
   }
